...
endpoint_message = {
    ...
    ("POST", "/api/survey"): "Ошибка создания опроса",
    ("GET", "/api/survey"): "Ошибка получения всех опросов",
    ("GET", "/api/survey/{id}"): "Ошибка получения опроса по id",
    ("PUT", "/api/survey/{id}"): "Ошибка изменения опроса по id",
    ("PATCH", "/api/survey/{id}"): "Ошибка частичного изменения опроса по id",
    ("DELETE", "/api/survey/{id}"): "Ошибка удаления опроса по id",
}
